...
class _$_Update implements _Update {
  ...
  @override
  String toString() {
    return 'ContactUpdateCubitState.update(id: $id)';
  }
...
abstract class _Update implements ContactUpdateCubitState {
  const factory _Update({required final String id}) = _$_Update;
